...
def parse_args():
    ...
    train_settings.add_argument('--learning_rate', type=float, default=0.003, help='optimizer type')
    train_settings.add_argument('--weight_dacay', type=float, default=0, help='weight decay')
    train_settings.add_argument('--dropout_keep_prob', type=float, default=0.8, help='dropout keep prob')
    train_settings.add_argument('--batch_size', type=int, default=64, help='train batch size')
    train_settings.add_argument('--epochs', type=int, default=200, help='train epochs')
    ...
    model_settings.add_argument('--num_layers', type=int, default=2,
                                help='RNN layer num')
    model_settings.add_argument('--max_x_len', type=int, default=385,
    ...
    path_settings.add_argument('--tensorboard_dir', default='tensorboard_dir/textRNN_GRU',
                               help='saving path of tensorboard')
    path_settings.add_argument('--save_dir', default='checkpoints/textRNN_GRU',
                               help='save base dir')
    ...
    # for x_test_batch, y_test_batch in test_batches:
        batch_predictions, batch_predict_probs = session.run([model.y_pred, model.probs],
                                                             feed_dict={
                                                                 ...
                                                                 model.input_q2: x_mask_test_batch,
