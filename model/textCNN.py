...
from model.layers.conv_layer import conv_layer
...
class TextCNN(object):
    ...
    def __init__(self, sequence_length, num_classes, vocab_size, learning_rate,
                 embedding_dim, filter_sizes, num_filters, is_training=False ,l2_reg_lambda=0.0):
        ...
        for i, filter_size in enumerate(filter_sizes):
            with tf.name_scope('conv-maxpool-%s' % filter_size):
                ...
                h = conv_layer(self.embedded_chars_expanded, filter_shape, is_training=is_training)
